package ch.abtomik.kura.example.camera_osgi;
...
public class CameraOsgi implements ConfigurableComponent {
    ...
    private static final Logger s_logger = LoggerFactory.getLogger(CameraOsgi.class);
